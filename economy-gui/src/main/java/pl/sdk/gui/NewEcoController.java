...
import pl.sdk.gui.buttons.NewCreatureButton;
...
public class NewEcoController implements PropertyChangeListener
{
// region fxml
    ...
    @FXML void initialize() throws Exception
    {
        ...
        for (int i = 1; i < 8; i++) {
            creaturesVBox.getChildren().add( new NewCreatureButton(
